...
public class PcmToWavUtil {
    ...
    public PcmToWavUtil(RecorderParameter recorderParameter) {
        this.mSampleRate = recorderParameter.getSampleRate();
        this.mChannel = recorderParameter.getChannel();
        this.mEncoding = recorderParameter.getAudioFormat();
        this.mBufferSize = AudioRecord.getMinBufferSize(mSampleRate, mChannel, mEncoding);
    }
