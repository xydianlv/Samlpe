package com.example.wyyu.gitsamlpe.test.fresco.cache;
...
public class ActivityFrescoCache extends BaseActivity {

    private static final int TIME_INTERVAL = 2000;

    public static void open(Context context) {
        context.startActivity(new Intent(context, ActivityFrescoCache.class));
    }
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fresco_cache);
    ...
    private void initBasic() {
        ...
        Drawable drawable = CMUtils.getImageHolderDrawable();
