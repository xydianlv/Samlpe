...
public class AspectRatioFrameLayout extends FrameLayout {
     ...
     *
     * <p>This tolerance allows the view to occupy the whole of the screen when the requested
     * aspect
     * ratio is very close, but not exactly equal to, the aspect ratio of the screen. This may
     * reduce
     * the number of view layers that need to be composited by the underlying system, which can
     * help
