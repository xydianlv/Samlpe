 ...
 **/
public class WaveViewQuick extends View {

    public WaveViewQuick(Context context) {
        super(context);
        initWaveView();
    }

    public WaveViewQuick(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initWaveView();
    }

    public WaveViewQuick(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
