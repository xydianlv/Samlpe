...
public class KeepLiveOnlyFloat extends Service {
    ...
    private static final String CHANNEL_NAME = "KeepLiveOnlyFloat";
    private static final String CHANNEL_ID = "service_live_float";
    ...
    @Override public void onCreate() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            Notification notification =
                new Notification.Builder(getApplicationContext(), CHANNEL_ID).build();
