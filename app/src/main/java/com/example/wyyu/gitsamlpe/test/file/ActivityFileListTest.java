...
public class ActivityFileListTest extends FullScreenActivity implements PresenterGetFile.ILocalFileListView{
    ...
    private void initCustomLayout() {
        ...
        customFrameLayout.setList(new int[]{R.id.file_list_content, R.id.file_list_empty, R.id.file_list_loading});
    }
    ...
    private void initGuideView() {
        ...
        topGuideView.setOnGuideItemClickListener(new TopGuideView.OnGuideItemClickListener() {
            @Override
            public boolean onClick(LocalFileBean fileBean) {
    ...
    @Override
    public void setFileList(LocalFileBeanList localFileBeanList) {
        viewAdapter.setLocalFileBeanList(localFileBeanList.getLocalFileBeanList());
    }

    @Override
    public void refreshGuestView(List<LocalFileBean> localFileBeanList) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        return (presenterGetFile != null && presenterGetFile.backLastFolder())
    ...
    private static class FileViewAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new FileViewHolder(
                LayoutInflater.from(context).inflate(R.layout.layout_file_list_item, parent, false));
        }
        ...
        private class FileViewHolder extends RecyclerView.ViewHolder {
            ...
            @SuppressLint("SetTextI18n") private void setDirInfo(final LocalFileBean fileBean) {
                ...
                String fileCount = "" + (fileBean.getFile().list() != null ? fileBean.getFile().list().length : 0);
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (presenterGetFile != null)
                            presenterGetFile.visitLocalFolder(fileBean);
                    }
                });
            }
