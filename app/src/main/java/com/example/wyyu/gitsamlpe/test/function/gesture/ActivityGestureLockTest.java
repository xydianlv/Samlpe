package com.example.wyyu.gitsamlpe.test.function.gesture;
...
public class ActivityGestureLockTest extends FullScreenActivity {
    ...
    public static void open(Context context) {
        context.startActivity(new Intent(context, ActivityGestureLockTest.class));
    }
    ...
    private void initGestureLockView() {
        ...
        gestureLockView.setOnDrawLockComplete(new GestureLockView.OnDrawLockComplete() {
            @Override public boolean onComplete(String password) {
    ...
    private void funViewAnimation(boolean isOpen) {
        ...
        ObjectAnimator animatorBottom =
            ObjectAnimator.ofFloat(bottomFunView, "translationY", bottomFunView.getTranslationY(),
                funNum * bottomFunView.getHeight());
        ObjectAnimator animatorTop =
            ObjectAnimator.ofFloat(topFunView, "translationY", topFunView.getTranslationY(),
                funNum * -topFunView.getHeight());
